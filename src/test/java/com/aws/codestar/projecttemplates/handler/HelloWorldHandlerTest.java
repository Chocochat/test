...
public class HelloWorldHandlerTest {
    ...
    void testHandleRequest() {
        ...
        assert(jsonObjectFromResponse.has("Holden"));
        assert(jsonObjectFromResponse.has("Toyota"));
        assert(jsonObjectFromResponse.has("MG"));
        assert(jsonObjectFromResponse.has("Mercedes"));
        assert(jsonObjectFromResponse.has("BMW"));
